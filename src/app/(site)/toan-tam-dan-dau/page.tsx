 ...
 * Tháng đã công bố mới nhất; mỗi hạng mục một khối (người dẫn đầu + bốn người kế tiếp — 09/09, phương án A, bỏ dải tab); chỉ hiện người đã đồng ý công khai.
 */
...
export default function Page() {
  ...
  const { published, latest, congKhai, hangMucCoNguoi } = useHonor();
  ...
  return (
    <>
      ...
      <div className="wrap py-10">
        {/* Tiêu đề tháng + ô chọn tháng (09/09, phương án A: bỏ dải tab hạng mục — mỗi hạng mục một khối bên dưới) */}
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-vien pb-3">
          <H2 className="text-[22px]">Bảng vinh danh {thangLabel(latest).toLowerCase()}</H2>
