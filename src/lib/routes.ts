...
export const R = {
  ...
  F04: (q?: string) => `/toan-tam-chia-se/tim-kiem${q ? `?q=${encodeURIComponent(q)}` : ""}`,
  // Tài khoản TVV
  G01: "/dang-nhap",
  G02a: "/tai-khoan",
  ...
  H21: "/cms/mau-danh-thiep",
  H21a: (id: string) => `/cms/mau-danh-thiep/${id}`,
...
export const CMS_MENU = [
  ...
  { code: "H21", label: "Mẫu danh thiếp", href: R.H21, editor: true },
